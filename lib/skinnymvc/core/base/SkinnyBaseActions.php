...
class SkinnyBaseActions {
   ...
   */
   public function call($module='default', $action='index', $request=array('GET'=>array(), 'POST'=>array())) {
      $moduleClass = SkinnyControllerCsvImportFree::camelize($module) . 'Actions';

      $actionMethod = 'execute'.SkinnyControllerCsvImportFree::camelize($action);
   ...
   */
   ...
   {
     SkinnyBaseControllerCsvImpFree::setLayout($layout);
   }
