...
<div class="box-one">
	<div class="top-right-box">
		<h3><span style="margin: -5px 5px 5px 5px;"><img src="<?php echo WP_CONST_CSV_IMP_DIR;?>images/chart_bar.png" /></span><?php echo __('Importers Activity','csv-import'); ?></h3>
	...
	<div class="top-right-box">
		<h3><span style="margin: -5px 5px 5px 5px;"><img src="<?php echo WP_CONST_CSV_IMP_DIR;?>images/stat_icon.png"></span><?php echo __('Import Statistics','csv-import'); ?></h3>
		<div class="top-right-content">
			<div id='dispLabel'></div>
