...
?>
<div id="ShowMsg" style="display:none;"><p id="setting-msg" class="alert alert-success"><?php echo __('Settings Saved', 'csv-import'); ?></p>
</div>

<?php 

$wpcsvsettings = get_option('csvimportsettings');
$debugmode = isset($wpcsvsettings['debug_mode']) ? $wpcsvsettings['debug_mode'] : '';
$allow_import = isset($wpcsvsettings['enable_plugin_access_for_author']) ? $wpcsvsettings['enable_plugin_access_for_author'] : '';
global $wpdb; ?>
...
<form class="add:the-list: validate" style = "width:98%;" action="" name="importerSettings" method="post" enctype="multipart/form-data">
        <span><label class="activemenu"><?php echo __('General Settings','csv-import'); ?></label></span>
...
<br>
<button class="btnn btn-primary" onclick="saveSettings();" style="margin-left:7px;padding:5px;" value="Save" name="savesettings" type="submit"><?php echo __('Save Changes','csv-import'); ?> </button>
<p style ="padding-top:20px;">
<label class="activemenu"><?php echo __('Security and Performance','csv-import'); ?></label>
</p>
<div id="section8" class="securityperformance">
                        <div class="databorder security-perfoemance" style = "width:98%">
                         ...
                         <tr><td>Mod Security </td><td><?php if(in_array('mod_security.c', $mod_security)) {
                                        ...
                                        <div style='float:left'>
                                                <a href="#" class="tooltip">
                                                        <img src="<?php echo WP_CONST_CSV_IMP_DIR; ?>images/help.png" style="margin-left:-74px;"/>
                                                        <span style="margin-left:20px;margin-top:-10px;width:150px;">
                                                                <img class="callout" src="<?php echo WP_CONST_CSV_IMP_DIR; ?>images/callout.gif"/>
...
<b><?php echo '<IfModule mod_security.c>';?> SecFilterEngine Off SecFilterScanPOST Off <?php echo ' </IfModule>';?></b>
                        ...
                        <h3 id="innertitle" colspan="2"style="padding-left:8px;">Debug Information:</h3>
                        <table class="table table-striped">
