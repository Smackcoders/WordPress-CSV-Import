...
?>
	...
	<!-- The global progress bar -->
          <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='button' name='clearform' id='clearform' title = '<?php echo __("Clear",'csv-import'); ?>' value='<?php echo $impCE->reduceStringLength(__("Clear",'csv-import'),'Clear'); ?>' onclick="Reload();" class='btn btn-warning' style="margin-right:15px;"/>
                          
                               <input type='submit' name='importfile' id='importfile' title = '<?php echo __("Next",'csv-import'); ?>' value='<?php echo $impCE->reduceStringLength(__("Next",'csv-import'),'Next');?> >>' disabled  class='btn btn-primary' style="margin-right:15px;"/>
                                </div>
                                </tr>
                                </table>
...
?>
		...
		<input type='button' id='clear_mapping' class='clear_mapping btn btn-warning' name='clear_mapping' title = '<?php echo __("Reset",'csv-import'); ?>' value='<?php echo __('Reset','csv-import'); ?>' onclick='clearMapping();' style = 'float:left'/>
		</div>
 ...
 <div id='importrightaway' style='display:block'>
		...
		<input id="startbutton" class="btn btn-primary" type="button" value="<?php echo __('Import Now','csv-import'); ?>" style="color: #ffffff;background:#2E9AFE;" onclick="importRecordsbySettings('<?php echo site_url(); ?>');" >
