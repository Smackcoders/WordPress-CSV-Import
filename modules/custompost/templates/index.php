...
?>
	...
	<!-- The global progress bar -->
         <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='submit' name='importfile' title = '<?php echo __('Next','csv-import');?>' id='importfile' value='<?php echo $impCE->reduceStringLength(__("Next",'csv-import'),'Next'); echo (" >>");?>' disabled
	...
	<?php if(isset($_REQUEST['__module']) && $_REQUEST['__module']=='custompost'){ ?>
		<div class='importstatus' style='display:true;'>
			...
			<div style = 'float:left'> <label id="importalign"> <?php echo __('Select Post Type','csv-import'); ?> </label> <span class="mandatory"> * </span> </div>
			...
			$pods = array();
                                $cust_post_pods = array();
                                $cust_post_pods = get_option('_transient_pods_get_type_post_type');
                                foreach($cust_post_pods as $cust_list => $value){
                                        $pods[] = $value['name'];
                                }
			...
			<img src="<?php echo WP_CONST_CSV_IMP_DIR; ?>images/help.png" />
			<span class="tooltipCustompost">
			<img class="callout" src="<?php echo WP_CONST_CSV_IMP_DIR; ?>images/callout.gif" />
			<strong><?php echo __('Select your custompost type','csv-import'); ?></strong>
			<img src="<?php echo WP_CONST_CSV_IMP_DIR; ?>images/help.png" style="margin-top: 6px;float:right;" />
			</span>
			</a><label id='cust_post_empty' style='display:none'><?php echo __('CUSTOMPOST LIST IS EMPTY','csv-import'); ?></label>
			</div>
			</div>
			<?php } ?>
